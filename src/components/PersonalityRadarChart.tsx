...
export const PersonalityRadarChart: React.FC<PersonalityRadarChartProps> = ({ insights }) => {
  ...
  const data = [
    { trait: 'Emotional\nStability', value: insights.emotionalStability, fullMark: 100 },
    { trait: 'Openness', value: insights.openness, fullMark: 100 },
    { trait: 'Conscientiousness', value: insights.conscientiousness, fullMark: 100 },
    { trait: 'Extraversion', value: insights.extraversion, fullMark: 100 },
    { trait: 'Agreeableness', value: insights.agreeableness, fullMark: 100 },
    { trait: 'Self-Reflection', value: insights.selfReflectionLevel, fullMark: 100 },
  ];
